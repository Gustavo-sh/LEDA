...
public class StudentAVLTest {
	...
	public void myTests() {
		...
		a.insert(new Integer(6));
		a.insert(new Integer(-34));
		a.insert(new Integer(-40));
		//a.insert(new Integer(5));
		//BSTVerifierImpl bf = new BSTVerifierImpl(a);
		//System.out.println(bf.isBST());
		//AVLTreeVerifierImpl av = new AVLTreeVerifierImpl(a);
		//System.out.println(av.isAVLTree());
		for(Integer i : (Integer[]) a.preOrder()) {
