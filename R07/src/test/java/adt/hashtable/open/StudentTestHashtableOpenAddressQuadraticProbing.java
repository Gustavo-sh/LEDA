...
public class StudentTestHashtableOpenAddressQuadraticProbing {
	...
	@Test
	public void myTests() {
		HashtableOpenAddressQuadraticProbingImpl h = new HashtableOpenAddressQuadraticProbingImpl(10, HashFunctionClosedAddressMethod.MULTIPLICATION, 2, 4);
		h.insert(new HashtableElement(5));
		h.insert(new HashtableElement(6));
		h.insert(new HashtableElement(11));
		h.insert(new HashtableElement(2));
		h.insert(new HashtableElement(6));
		h.remove(new HashtableElement(6));
		h.remove(new HashtableElement(3));
		h.insert(new HashtableElement(0));
		h.insert(new HashtableElement(9));
		h.remove(new HashtableElement(9));
		h.remove(new HashtableElement(0));
		h.insert(new HashtableElement(15));
		System.out.println(h.toS());
		assertEquals(new HashtableElement(11), h.search(new HashtableElement(11)));
		assertEquals(1, h.indexOf(new HashtableElement(11)));
		assertEquals(7, h.indexOf(new HashtableElement(15)));
	}
}
