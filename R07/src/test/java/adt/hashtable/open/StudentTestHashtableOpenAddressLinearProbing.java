...
public class StudentTestHashtableOpenAddressLinearProbing {
	...
	@Test
	public void myTests() {
		HashtableOpenAddressLinearProbingImpl h = new HashtableOpenAddressLinearProbingImpl(10, HashFunctionClosedAddressMethod.MULTIPLICATION);
		h.insert(new HashtableElement(1));
		h.insert(new HashtableElement(2));
		h.insert(new HashtableElement(3));
		h.insert(new HashtableElement(0));
		h.insert(new HashtableElement(1));
		System.out.println(h.toS());
		h.remove(new HashtableElement(1));
		h.remove(new HashtableElement(1));
		System.out.println(h.toS());
		h.insert(new HashtableElement(1));
		h.insert(new HashtableElement(4));
		System.out.println(h.toS());
		assertEquals(new HashtableElement(3), h.search(new HashtableElement(3)));
		assertNotEquals(2, h.indexOf(new HashtableElement(3)));
	}
}
