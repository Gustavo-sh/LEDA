...
public class StudentTestHashtableClosedAddressDivisionMethod {
	...
	@Test
	public void myTests() {
		HashtableClosedAddressImpl h = new HashtableClosedAddressImpl(10, HashFunctionClosedAddressMethod.DIVISION);
		...
		h.insert(9);
		h.insert(45);
		//System.out.println(h.search(new Integer(3)));
		//System.out.println(h.search(4));
		System.out.println(h.exibe());
		System.out.println(h.indexOf(45));
