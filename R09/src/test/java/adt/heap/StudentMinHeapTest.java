...
public class StudentMinHeapTest {
	...
	@Test
	public void myTests() {
		HeapImpl h = new HeapImpl(new ComparatorMinHeap());
		FloorCeilHeapImpl fc = new FloorCeilHeapImpl(new ComparatorMinHeap());
		//h.buildHeap(arr1);
		Integer[] a = { 34, 92, 5, 12, 49, 20, 43, 44, 6 };
		Integer[] a2 = (Integer[]) h.heapsort(a);
		for(Integer i : a) {
			System.out.println(i);
		}
		System.out.println(fc.ceil(a, 31));
		//OrderStatisticsHeapImpl o = new OrderStatisticsHeapImpl();
		//System.out.println(o.getOrderStatistics(arr1, 1));
	}
}
